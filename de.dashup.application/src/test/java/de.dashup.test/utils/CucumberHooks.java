...
public class CucumberHooks {
    ...
    public void doDatabaseSetup() throws SQLException, IOException {
        ...
        testDataMap.put("short_description","test test test test test test test test test test test test test test test test");
        ...
        testDataMap.put("number_of_downloads",10);
        ...
        testDataMap.clear();
        testDataMap.put("user_id",1);
        testDataMap.put("name","panel42");
        testDataMap.put("short_description","yeah yeah yeah yeah yeah yeah yeah yeah yeah yeah yeah yeah yeah yeah yeah");
        testDataMap.put("description","long description 42");
        testDataMap.put("publication_date","2019-01-01");
        testDataMap.put("visibility",1);
        testDataMap.put("number_of_ratings", 10);
        testDataMap.put("avg_of_ratings", 30);
        testDataMap.put("number_of_downloads",8);
        testDataMap.put("code_small", "<h1>Widget 1</h1>");
        testDataMap.put("code_medium", "<h1>Widget 1</h1>");
        testDataMap.put("code_large", "<h1>Widget 1</h1>");
        database.insert(Database.Table.PANELS,testDataMap);
