    ...
    <nav>
        <div class="nav-wrapper">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li id="li-for-nav-item-marketplace"><a href="${fn:escapeXml(pageContext.request.contextPath)}/marketplace/" id="nav-item-marketplace"><fmt:message key="i18n.marketplace"/></a></li>
                ...
                <li id="li-for-nav-item-settings"><a href="${fn:escapeXml(pageContext.request.contextPath)}/settings/" id="nav-item-settings"><fmt:message key="i18n.settings"/></a></li>
            </ul>
        </div>
    </nav>
